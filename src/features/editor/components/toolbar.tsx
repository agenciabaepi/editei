...
export const Toolbar = ({
  ...
  if (editor?.selectedObjects.length === 0) {
    return (
      <div className="shrink-0 h-[56px] border-b bg-white w-full flex items-center overflow-x-auto z-[49] p-2 gap-x-2">
        {/* Background tool should always be available */}
        <div className="flex items-center h-full justify-center">
          <Hint label="Background" side="bottom" sideOffset={5}>
            <Button
              onClick={() => onChangeActiveTool("background")}
              size="icon"
              variant="ghost"
              className={cn(activeTool === "background" && "bg-gray-100")}
            >
  ...
  return (
    <div className="shrink-0 h-[56px] border-b bg-white w-full flex items-center overflow-x-auto z-[49] p-2 gap-x-2">
      ...
      <div className="flex items-center h-full justify-center">
        <Hint label="Gradient" side="bottom" sideOffset={5}>
          <Button
